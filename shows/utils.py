    ...
    if response.status_code == 200:
        ...
        for season in response_json:
            ...
            for episode in episodes:
                episode_obj = Episode.objects.create(episode_id=episode.get("id"), episode_title=episode.get("title"), 
